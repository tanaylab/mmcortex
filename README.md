...
3) In the repo's directory, download processed data (~4.5GB) using `wget  https://mmcortex.s3.eu-west-1.amazonaws.com/mmcortex.tar.gz`
...
2) Download container (~20GB): `wget https://mmcortex.s3.eu-west-1.amazonaws.com/mmcortex_docker.tar`
