...
# mcATAC::save_pheatmap(p_filt_non_cort_rna, fig_s1b_path, h = 1200, w = 2000)
...
# mcATAC::save_pheatmap(p_gene_module_phm, fig_s1c_path, h = 2800, w = 4200, res = 200)
...
# mcATAC::save_pheatmap(p_legc_nsc_mat_neu_scores_avg_ct, fig_s1g_path, h = 600, w = 600)
...
# mcATAC::save_pheatmap(p_neuro_markers, fig_s1h_path, h = 3000, w = 2000)
