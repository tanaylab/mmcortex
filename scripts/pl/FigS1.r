...
fig_s1a_path <- './output/paper_figs/FigS1/FigS1A.png'
fig_s1b_path <- './output/paper_figs/FigS1/FigS1B.png'
fig_s1c_path <- './output/paper_figs/FigS1/FigS1C.png'
fig_s1d_path <- './output/paper_figs/FigS1/FigS1D.png'
fig_s1e_path <- './output/paper_figs/FigS1/FigS1E.png'
fig_s1f_path <- './output/paper_figs/FigS1/FigS1F.png'
fig_s1g_path <- './output/paper_figs/FigS1/FigS1G.png'
fig_s1h_path <- './output/paper_figs/FigS1/FigS1H.png'
...
print(c('Fabp7',unique(unlist(mbm_lst))))
...
mcATAC::save_pheatmap(p_filt_non_cort_rna, fig_s1a_path, h = 1200, w = 2000)
...
mcATAC::save_pheatmap(p_gene_module_phm, fig_s1b_path, h = 2800, w = 4200, res = 200)
...
mcATAC::save_pheatmap(p_legc_nsc_mat_neu_scores_avg_ct, fig_s1f_path, h = 600, w = 600)
...
mcATAC::save_pheatmap(p_neuro_markers, fig_s1g_path, h = 3000, w = 2000)
...
png(fig_s1h_path, h = 650, w = 450)
cust_st_ord_filt <- cust_st_ord[!(cust_st_ord  %in% c('Astrocytes', 'Oligodendrocytes'))]
...
vioplot(rev(sort(pcu_ord_filt)) ~ factor(mcmd$cell_type[pcu_ord_filt], levels = cust_st_ord_filt), col = col_key[cust_st_ord_filt], horizontal = T, ylab = '',xlab = '')
title(xlab = 'Differentiation order', line =6)
title(ylab = 'Cell type', line = 9)
dev.off()